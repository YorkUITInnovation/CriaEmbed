import {Example, Get, Middlewares, OperationId, Path, Produces, Query, Request, Route, Tags} from "tsoa";
...
const EMBED_BASE_SCRIPT: string = fs.readFileSync(
    path.join(Config.ASSETS_FOLDER_PATH, "/public/popup/embed.js")
).toString();

@Route("/embed/{botId}/popup.js")
export class EmbedPopupJSController extends BaseController {
  ...
  @OperationId("embedGetPopupJs")
  public async getPopupEmbedJs(
      @Path() botId: string,
