...
const ToolTip = styled.div`
    ...
    &:after {
        content: "This response was manually verified.";
        text-wrap: nowrap;
        position: absolute;
        top: -35px;
        right: 0;
...
export default function VerifiedResponseTooltip() {
    ...
    <TooltipContainer>
      <ToolTip>
        ...
        >
          ...
          <path xmlns="http://www.w3.org/2000/svg" d="M8.5 12.5L10.5 14.5L15.5 9.5" stroke="currentColor" strokeWidth="2"
