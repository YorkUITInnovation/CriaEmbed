...
export default class AboutCommand extends Command {
    ...
    getDescription() {
        return "All about AURA"
    }

    async execute(text, ref = undefined) {

        return `This bot, ${window.Cria.botName} (${window.Cria.botSubName || "N/A"}), is one of many AURA bots.<br><br/>`
          + `AURA is a chat-bot system created by IT Innovation at York University.<br/><br/>`
          ...
          + `Cria first launched to the public on Mon, August 26th, 2024.`
    }
}
